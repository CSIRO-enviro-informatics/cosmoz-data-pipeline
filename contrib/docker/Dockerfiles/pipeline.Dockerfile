...
RUN apk add --no-cache bash tini-static python3 py3-virtualenv libuv libstdc++ freetds openssl curl
RUN apk add --no-cache --virtual buildenv git libuv-dev libffi-dev freetds-dev python3-dev openssl-dev py3-cffi build-base
